...
> Error `"Model not allowed for edit: openai/gpt-image-2/edit"` means the **backend
> allow-list** rejected the id, not fal. Add this exact string to the edit allow-list.
> See [`backend-image-models-guide.md`](./backend-image-models-guide.md).
...
| Insufficient balance | `402` `{ "message": "Insufficient credits", "code": "INSUFFICIENT_CREDITS" }` |
...
| 402 | Not enough credits | `{ "message": "Insufficient credits", "code": "INSUFFICIENT_CREDITS" }` |
